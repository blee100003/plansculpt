"""
Django settings for plansculpt_backend project.
...
SECRET_KEY = 'django-insecure-=revqrblw4w_segx(vxtbq6kq_*60p5n2-b7_8og)vwwv4=$$z'
...
ROOT_URLCONF = 'plansculpt_backend.urls'
...
WSGI_APPLICATION = 'plansculpt_backend.wsgi.application'
